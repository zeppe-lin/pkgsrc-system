...
**Note:** Additional Device Mapper options exist beyond those listed.
To run regression tests properly, enable all necessary options as
modules or built-in.  The tests will time out if Magic SysRq key is
not enabled.
