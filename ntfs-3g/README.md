...
Linux kernel 5.15 introduced **NTFS3**, a faster NTFS read-write
driver.  To enable it, configure the kernel as follows:
...
require its utilities (e.g., to create NTFS filesystems).

User Mount
----------

To allow ordinary users to mount NTFS partitions, set `mount.ntfs`
with the root UID:
...
**Note:** It is probably unsafe to do this on a computer that needs to
be secure!
